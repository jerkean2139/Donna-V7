  ...
  return (
    <form action={formAction} className="mt-8 space-y-6" aria-busy={isPending}>
      ...
      <label className="block">
        ...
        <select name="objectType" className="mt-2 w-full rounded-lg border border-border-default p-3">
      ...
      <label className="block">
        ...
        <span className="ml-2 text-xs text-text-muted">What are you trying to accomplish? (decisions)</span>
        <textarea
          name="objective"
          rows={2}
          maxLength={2000}
