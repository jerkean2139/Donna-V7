  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-5xl flex-col justify-center px-6 py-16">
      ...
      <div className="mt-8 flex gap-4">
        <Link className="rounded-lg bg-cyan px-5 py-3 text-bg-base" href="/dashboard">
          Open dashboard
        </Link>
        <Link className="rounded-lg border border-border-default px-5 py-3" href="/cognitive-objects">
          View objects
        </Link>
        <Link className="rounded-lg border border-border-default px-5 py-3" href="/decisions">
          View decisions
        </Link>
      </div>
    </main>
